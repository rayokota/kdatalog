...
public class DatalogComputation implements ComputeFunction<String, String, String, String> {
    ...
    public void init(Map<String, ?> configs, InitCallback cb) {
        cb.registerAggregator(ROUND_AGGREGATOR, LongMaxAggregator.class);
        cb.registerAggregator(VOTE_AGGREGATOR, BooleanAndAggregator.class);
        cb.registerAggregator(LAST_TIME_AGGREGATOR, BooleanOrAggregator.class);
    }

    @Override
    public void masterCompute(int superstep, MasterCallback cb) {
        if (superstep == 0) {
            cb.setAggregatedValue(ROUND_AGGREGATOR, 0L);
            cb.setAggregatedValue(VOTE_AGGREGATOR, true);
            cb.setAggregatedValue(LAST_TIME_AGGREGATOR, false);
        }
    }
    ...
    public void compute(
        ...
        Callback<String, String, String, String> cb) {
    ...
    private void sendMessage(Callback<String, String, String, String> cb, String target, String message) {
        cb.sendMessageTo(target, message);
    }

    private void setVertexValue(Callback<String, String, String, String> cb, String value) {
        cb.setNewVertexValue(value);
    }

    private void voteToHalt(Callback<String, String, String, String> cb, VertexWithValue<String, String> vertex) {
